...
<body>
    ...
    <section class="hero" id="inicio">
        ...
        <div class="botoes-grupo">
            ...
            <a href="https://www.instagram.com/jp.marketing.oficial?utm_source=qr" target="_blank" class="btn btn-secundario">
                <i class="fab fa-instagram"></i> @jp.marketing.oficial
            </a>
        </div>
    </section>
        ...
        <div class="grid-contato">
            <div class="contato-info">
                ...
                <div class="lista-canais">
                    ...
                    <a href="https://www.instagram.com/jp.marketing.oficial?utm_source=qr" target="_blank" class="canal-item">
                        <i class="fab fa-instagram"></i>
                        <div>
                            <h5>Instagram Oficial</h5>
                            <p>@jp.marketing.oficial (Acompanhe nossos bastidores)</p>
                        </div>
                    </a>
    ...
    <footer>
        ...
        <a href="https://www.instagram.com/jp.marketing.oficial?utm_source=qr" target="_blank" class="footer-insta">
            <i class="fab fa-instagram"></i> Siga-nos no Instagram: @jp.marketing.oficial
        </a>
    </footer>
